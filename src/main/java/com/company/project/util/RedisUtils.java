...
public class RedisUtils {
    ...
    private static final String ip = PropertyResources.getInstance().getProperties().get("spring.redis.host");
    //    private static final String ip = "101.133.136.114";
