...
@Table(name = "LEG_USER_GROUP_PRIVILEGE_MAP_MENU_VIEW")
public class LegUserGroupPrivilegeMapMenuView {
    @Id
    @Column(name = "OPEN_UNID")
    private String openUnid;
     ...
     * @param openUnid
     */
    public void setOpenUnid(String openUnid) {
        this.openUnid = openUnid;
    }
